...
func (c *categoryServiceClient) GetCategory(ctx context.Context, in *CategoryId, opts ...grpc.CallOption) (*CategoryResponse, error) {
	out := new(CategoryResponse)
...
func (UnimplementedCategoryServiceServer) GetCategory(context.Context, *CategoryId) (*CategoryResponse, error) {
